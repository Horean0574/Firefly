...
published: 2026-02-08 # 21:50:43
updated: 2026-02-10 # 12:14:25
...
```tsx title="src/pages/friends.astro" startLineNumber=33 ins={18,19,20}
<!-- 页面标题和描述 -->
<div class="mb-4">
  ...
  </div>
  {
    description && (
      ...
      <div class="callout">
        <p class="text-sm">📚 此处的友情链接均以添加至本站的时间先后顺序排列~</p>
      </div>
    )
  }
</div>
